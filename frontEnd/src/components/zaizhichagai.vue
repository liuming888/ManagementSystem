...
<template>
    <div class="bigbox">
        <el-dialog title="职员信息表" :visible.sync="chagaishuju.dialogFormVisible" top="0" class="box" center>
            <p>
            ...
            <div class="main">
                ...
                <p class="btn">
                    ...
                    <el-button icon="el-icon-delete" round type="text" @click="shanchu">离职</el-button>
    ...
    export default {
      ...
      methods: {
        xiugai() {
          ...
          this.$store.dispatch("ZAIZHIXIUGAI", {
            //修改填写内容过去
